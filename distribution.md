...
Good grip on pop culture and memes wouldn't hurt.

Four Channels for Scale (Profitability Ranking)

- App store optimization (free forever)
- Organic content (algorithm upside, no ad spend)
...
Your reach might die if you only use ads tbh, organic fanbase > manufactured advertisement engine which stops working after you pay.

Copy competitors video ideas. The big 3 of post ideas:
-Reaction clip + demo
-Slideshows (consistent brand identity)
-Memes
...
Widely considered the best way to scale mobile apps right now. You hire micro influencers to make new accounts that produce content just for your app. Having a successful UGC army is significantly harder.
...
Notes:
- hard-paywalls work a lot better
...
(sprinkled with aha moments, make them feel weight of problem, study successful onboarding, when a user dismisses your paywall, trigger a better closing offer)

[revenueCat analysis](https://www.revenuecat.com/state-of-subscription-apps/#plan-duration-mix-by-category-1lv253)

- learn about users ❌
- users reflect on their answers + get convinced that problem is real ✅
- test different paywall versions

Mirror the user's answers back to them so they feel like the experience is being built specifically for them. Longer onboarding is better (12-15). Let the user actually use your core feature during Mirror the user's answers back to them so they feel like the experience is being built specifically for them.

#### Triggering Reviews (ASO & Social Proof)
